...
<?php
         $buscardor = $client->run("MATCH (p:Person) WHERE p.cedula =  '".$_POST['buscar']."' return p");
         foreach ($buscardor as $result) {
            $node = $result->get('p');
            }

            $buscardor2 = $client->run("MATCH (p:Person) WHERE p.cedula =  '".$_POST['buscar2']."'  return p");
        ...
        <h5><strong>Datos de la Persona 1</strong></h5> 
        	<hr/>                 
                    <div class="row align-items-start">
                        ...
                        <label><?php echo $node->getProperty('nombres'); ?></label>
                        </div>
                        
                        <div class="col">
                        <label><strong>Apellido:</strong></label>
                        <label><?php echo $node->getProperty('apellidos'); ?></label>
                        </div>
                        ...
                        <div class="col">
                        <label><strong>Cedula del Conyugue:</strong></label>
                        <label><?php echo $node->getProperty('cedulaConyuge'); ?></label>                    
                        </div>
        ...
        <h5><strong>Datos de la Persona 2</strong></h5> 
        	<hr/>                 
                    <div class="row align-items-start">
                        <div class="col">
                        <label><strong>Nombre:</strong></label>
                        <label><?php echo $node2->getProperty('nombres'); ?></label>
                        </div>
                        
                        <div class="col">
                        <label><strong>Apellido:</strong></label>
                        <label><?php echo $node2->getProperty('apellidos'); ?></label>
                        </div>
                        ...
                        <div class="col">
                        <label><strong>Cedula del Conyugue:</strong></label>
                        <label><?php echo $node2->getProperty('cedulaConyuge'); ?></label>
                        </div>
...
<hr/> 
        ...
        <input class="form-control" type="text" id="persona1" name="persona1" value="<?php echo $node->getProperty('nombres'); ?>" readonly><br><br>

        <h3 class="h3 mb-0 text-gray-800"> Persona 2 seleccionada: </h3>
        <input class="form-control" type="text" id="persona2" name="persona2" value="<?php echo $node2->getProperty('nombres'); ?>" readonly><br><br>
