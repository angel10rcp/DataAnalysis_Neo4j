                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <form
                        ...
                        <div class="input-group">
                            <input type="text"  id="queryText" class="form-control bg-light border-0 small" placeholder="Buscar por número de cédula"
                                aria-label="Search" aria-describedby="basic-addon2">
                            <div class="input-group-append">
                                <button id="btnSend" class="btn btn-dark" type="button">
...
<script src="../js/jquery-3.3.1.min.js"></script>
  ...
  <script type="text/javascript">
    ...
    var neo4jAPIURL = 'http://localhost:7474/db/demo2/tx/commit';
    var neo4jLogin = 'neo4j';
    var neo4jPassword = '12345678';
    ...
    function showProperties(d) {
      ...
      //For nodes
      if (d.labels != null)
        propertiesText += ' Propiedades: ' + d.labels.join(', ');
      //For links
      if (d.type != null)
...
////////////////////////////////////////////////////////////////////////////////////////
    ...
    function submitQuery(nodeID) {
      ...
      if (nodeID == 1 || !nodeID) {
        ...
        if ($('#chkboxCypherQry:checked').val() != 0)
          queryStr = 'match (n) return n limit 10000';
      } else
